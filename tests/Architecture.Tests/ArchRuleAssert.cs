...
/// <summary>
/// Replaces <c>TngTech.ArchUnitNET.xUnit</c>'s <c>Check()</c> extension. That package still depends
/// on <c>xunit.assert</c> 2.x, which cannot coexist with xunit v3, so we evaluate the rule against
/// the core ArchUnitNET API and fail through xunit ourselves.
/// </summary>
